    ...
    while previousNode is not goalNode:
        ...
        while True:
            ...
            if data['distance'] > prevTotalDistance:
                ...
                voiceOutput.setSpeechTriggerStep(prevStepsTaken)
            ...
            if abs(turnAngle) > 20:
                ...
                if not counter:
                    ...
                    voiceOutput.setSpeechTriggerTurn(99)
                    counter += 1
                else:
                    counter = (counter + 1) % 4
            else:
                ...
                print instruction
                if not counterx:
                    voiceOutput.setSpeechTriggerWalk(distanceToNode)
                    #voiceOutput.addToQueue(INSTRUCTION(instruction, 0, time.time()))
                    counterx += 1
                else:
        ...
        voiceOutput.setSpeechTriggerNode(previousNode)
